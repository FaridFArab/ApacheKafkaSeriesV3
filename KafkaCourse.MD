...
### Kafka Connect: Tool used for receive and send data with databases and sink data. A connect cluster made from workers. Get data from source and sink to outsource.